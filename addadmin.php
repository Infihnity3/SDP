            ...
            <div class="row add" style="width: 800px;background-color: rgba(0,0,0,0.37);">
                <div class="col-md-12">
                    <form style="background-repeat: no-repeat;background-size: auto;">
                        ...
                        <div class="form-group text-left"><input class="form-control" type="text" style="width: 300px;margin-left: 230px;background-color: rgb(247,249,252);" name="adminname" placeholder="Fullname"></div>
                        <div class="form-group text-left"><input class="form-control" type="text" style="width: 300px;margin-left: 230px;background-color: rgb(247,249,252);" name="adminic" placeholder="IC Number"></div>
